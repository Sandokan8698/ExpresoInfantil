...
public class Utils {
    ...
    public static void ShowProgessDialog(Context context, String menssage)
    {
    ...
    public static void showMensage(final Context context, String menssage) {
        try {
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(context, R.style.MyAlertDialogStyle);
            mBuilder.setMessage(menssage);
            mBuilder.setPositiveButton(context.getString(R.string.txt_ok),
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
